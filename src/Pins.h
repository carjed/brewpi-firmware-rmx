...
#elif BREWPI_STATIC_CONFIG == BREWPI_SHIELD_I2C || BREWPI_STATIC_CONFIG == BREWPI_SHIELD_GLYCOL

    #ifndef oneWirePin
        #define oneWirePin A0 // OneWire Sensors
    #endif

    #ifndef actuatorPin1
        #define actuatorPin1 5 // Generally 'Cool'
    #endif

    #ifndef actuatorPin2
        #define actuatorPin2 6 // Generally 'Heat'
    #endif

    #ifndef actuatorPin3
        #define actuatorPin3 2 // Avail for fan or light
    #endif

    #ifndef actuatorPin4
        #define actuatorPin4 10 // Avail for fan or light
    #endif

    #ifndef doorPin
        #define doorPin 4 // Connects to fridge door switch
    #endif

    #ifndef alarmPin
        #define alarmPin 3 // Piezo buzzer
    #endif
